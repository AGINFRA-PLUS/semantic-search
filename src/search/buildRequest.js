...
export default function buildRequest(state) {
  ...
  const filtersObj = buildRequestFilter(filters);
  ...
  const body = {
    ...
    _source: ["tags", "title", "description"],
    aggs: {
      vocs: { terms: { field: "vocabulary.keyword", size: 30 } },
    ...
    ...(from && { from })*/
      ...
      "apikey": "5ca5a4e4-d391-32ca-bf73-28f11ce90e01",
      "freetext": match,
      "smart": filtersObj.config.smart,
      "aggregations": {
        "tags": {
          "attribute": "tags.keyword",
          "size": 200
        },
        "entityType": {
          "attribute": "entityType.keyword",
          "size": 200
        },
        "informationType": {
      ...
      "method": "children",
      "strictQuery": filtersObj.strictQuery,
      "pageSize": size,
      "page": from
